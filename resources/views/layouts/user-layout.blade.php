...
<html lang="en">
    <head>
        ...
        <script src="{{
                asset('row_merger/dist/row-merge-bundle.min.js')
            }}"></script>
  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
    ...
    <body>
        ...
        <header id="header" class="header fixed-top d-flex align-items-center">
            <div class="d-flex align-items-center justify-content-between">
                <a href="index.html" class="logo d-flex align-items-center">
                    ...
                    <span class="d-none d-lg-block">Maruf Blog</span>
                </a>
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        >
                            <img
                                ...
                                width="30px"
                                height="30px"
                                src="{{ asset('storage/images/'.$user_image) }}"
                                alt="profile image"
                            />
                            <span
                                class="d-none d-md-block dropdown-toggle ps-2"
                                >{{$logged_user->name}}</span
                            >
                        </a>
        ...
        <main id="main" class="main">@yield('space-work')</main>
        <!-- End #main -->
