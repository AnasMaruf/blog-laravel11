    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col">
                <div
                    class="card"
                    style="background-color: #98a0e3; font-size: 20px"
                >
            ...
            <div class="col">
                <div
                    class="card"
                    style="background-color: #3ade9f; font-size: 20px"
                >
                    <div class="card-body text-center text-white">Comments</div>
                    <div
                        class="card-footer text-center text-white"
            ...
            <div class="col">
                <div
                    class="card"
                    style="background-color: #e3a598; font-size: 20px"
                >
                    <div class="card-body text-center text-white">Posts</div>
                    <div
                        class="card-footer text-center text-white"
                        style="background-color: #e3a598"
                    >
                        {{ $post_count }}
                    </div>
                </div>
