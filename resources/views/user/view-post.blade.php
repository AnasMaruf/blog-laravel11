    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    <img
                        src="{{ asset('storage/images/' .$post_data->photo) }}"
                        alt=""
                        class="card-img-top"
                    />
                    <div class="row my-2">
                        <div class="col-xl-6">
                            ...
                            <span
                                class="text-muted"
                                >{{date('d-m-Y h:i',strtotime($post_data->created_at))}}</span
                            >
                            <br />
                            <a
                                href="/view/profile/{{$post_data->user_id}}"
                                wire:navigate
                            >
                                ...
                                />
                                <span
                                    class="text-muted mx-3 text-capitalize my-1"
                                >
                                    {{$post_data->name}}</span
                                >
                            </a>
                            <livewire:follow-component
                                :followedId="$post_data->user_id"
                            />
                        </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body pb-0">
                    <h5 class="card-title">
                        More posts from {{$post_data->name}}
                    </h5>
